...
public class Poo extends Entity{
	...
	public static final Spritesheet poo_sprites = new Spritesheet("res/spritesheets/poo_spritesheet.png", 64);
	
	public static final Sprite frame_0 = new Sprite(poo_sprites, 16, 0, 0);
	public static final Sprite frame_1 = new Sprite(poo_sprites, 16, 1, 0);
	public static final Sprite frame_2 = new Sprite(poo_sprites, 16, 2, 0);
	public static final Sprite frame_3 = new Sprite(poo_sprites, 16, 3, 0);
